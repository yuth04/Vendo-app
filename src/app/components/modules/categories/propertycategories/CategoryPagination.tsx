...
const CategoryPagination: React.FC<PaginationProps> = ({ currentPage, totalPages, onPrev, onNext, onSetPage }) => {
    ...
    return (
        <div className="flex items-center justify-center gap-1 py-8 sm:py-16 ">
            <button
                onClick={onPrev}
