...
const PromotionsPagination: React.FC<PaginationProps> = ({ currentPage, totalPages, onPrev, onNext, onSetPage }) => {
    ...
    return (
        <div className="flex items-center justify-center gap-1 py-8 sm:py-10">
            <button
                onClick={onPrev}
